...
function Detail() {
    ...
    const fetchData = async () => {
        try {
            // 포스트 정보 GET
            const imgPostPullData = await axios.get(`http://13.124.66.197:8000/post/${postPk}/`);
            ...
            setPostData({
                ...
                image1: imgPostPullData.data.image1,
                image2: imgPostPullData.data.image2,
                image3: imgPostPullData.data.image3,
                image4: imgPostPullData.data.image4,
                image5: imgPostPullData.data.image5,
                image6: imgPostPullData.data.image6,
                image7: imgPostPullData.data.image7,
                image8: imgPostPullData.data.image8,
                image9: imgPostPullData.data.image9,
                image10: imgPostPullData.data.image10,
            ...
            const commentPullData = await axios.get(
                `http://13.124.66.197:8000/post/${postPk}/comments/`
            );
    ...
    const commentSubmit = async (e) => {
        e.preventDefault();
        await axios
            .post(`http://13.124.66.197:8000/post/${postPk}/comments/`, {
                content: inputValue,
            })
            .then((res) => {
    ...
    const clickHeart = async (e) => {
        e.preventDefault();
        await axios
            .patch(`http://13.124.66.197:8000/post/${postPk}/send_like/`)
            .then((res) => {
                console.log(res, "좋아요");
            })
            .catch((res) => {

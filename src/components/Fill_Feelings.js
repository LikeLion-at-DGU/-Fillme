...
function Fill_feelings({
    ...
    const image_style = {
        backgroundImage: `url(http://13.124.66.197:8000${image})`,
    ...
    if (hover) {
        return (
            ...
            >
                {/* {image === null ? (
                    <video src={`http://13.124.66.197:8000${video}`} type="video/mp4">
                        대체 텍스트
                    </video>
                ) : null} */}
                ...
                <div className="feelings_content2">
                    ...
                    <img src={`http://13.124.66.197:8000${personaimage}`} id="feed_image" />
